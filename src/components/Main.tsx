...
export default function Main(){
    ...
    return(
        <main className='w-full h-screen flex pl-5 justify-center relative align-center text-center'>
            <div className='flex flex-col w-3/5 justify-center align-center'>
            ...
            <div className=' w-2/5 flex flex-col justify-center align-center'>
